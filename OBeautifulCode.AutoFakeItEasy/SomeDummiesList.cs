...
namespace OBeautifulCode.AutoFakeItEasy
{
    ...
    public class SomeDummiesList<T> : List<T>
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the number of elements in the list to generate as specified in the call to <see cref="Some.Dummies{T}(int,AutoFakeItEasy.CreateWith)"/>.
        /// </summary>
        internal int NumberOfElementsSpecifiedInCallToSomeDummies { get; }

        /// <summary>
        /// Gets a value that determines if and how to populate the list with nulls as specified in the call to <see cref="Some.Dummies{T}(int,AutoFakeItEasy.CreateWith)"/>
        /// </summary>
        internal CreateWith CreateWithSpecifiedInCallToSomeDummies { get; }
    }
}
