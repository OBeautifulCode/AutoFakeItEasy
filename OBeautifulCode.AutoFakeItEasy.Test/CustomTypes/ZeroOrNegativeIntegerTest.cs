...
namespace OBeautifulCode.AutoFakeItEasy.Test
{
    ...
    {
        [Fact]
        public static void Constructor___When_the_value_parameter_is_positive___Throws_ArgumentOutOfRangeException()
        {
            // Arrange, Act
        ...
        [Fact]
        public static void Constructor___When_the_value_parameter_is_zero_or_negative___Does_not_throw()
        {
            // Arrange, Act
