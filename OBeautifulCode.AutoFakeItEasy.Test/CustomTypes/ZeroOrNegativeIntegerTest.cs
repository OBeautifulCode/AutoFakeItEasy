...
namespace OBeautifulCode.AutoFakeItEasy.Test
{
    ...
    {
        [Fact]
        public static void Constructor_When_the_value_parameter_is_positive_Then_constructor_throws_ArgumentOutOfRangeException()
        {
            // Arrange, Act
        ...
        [Fact]
        public static void Constructor_When_the_value_parameter_is_zero_or_negative_Then_constructor_does_not_throw()
        {
            // Arrange, Act
